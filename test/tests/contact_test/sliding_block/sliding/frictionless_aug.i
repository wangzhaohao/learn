...
[Problem]
  ...
  # 使用augmented_largrange必须配合AugmentedLagrangianContactProblem使用
  # 主要的参数就是maximum_lagrangian_update_iterations，其他的都是使用默认即可，此处使用solution_variables='disp_x disp_y'
  # extra_tag_vectors 和reference_vector都是和Master中的extra_vector_tag='ref'对应
